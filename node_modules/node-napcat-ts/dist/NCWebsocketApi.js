...
export class NCWebsocketApi extends NCWebsocketBase {
     ...
     * 群聊全员禁言
     */
    async set_group_whole_ban(params) {
     ...
     * 设置群聊专属头衔
     */
    async set_group_special_title(params) {
     ...
     * 处理好友添加请求
     */
    async set_friend_add_request(params) {
     ...
     * 处理群聊添加请求
     */
    async set_group_add_request(params) {
     ...
     * 获取陌生人的信息
     */
    async get_stranger_info(params) {
     ...
     * 获取群成员列表
     */
    async get_group_member_list(params) {
     ...
     * 获取群荣誉
     */
    async get_group_honor_info(params) {
     ...
     * 获取在线客户端
     */
    async get_online_clients(params) {
     ...
     * 发送群合并信息
     */
    async send_group_forward_msg(params) {
     ...
     * 发送私聊合并信息
     */
    async send_private_forward_msg(params) {
     ...
     * 获取群聊系统信息
     */
    async get_group_system_msg(params) {
     ...
     * 获取精华信息列表
     */
    async get_essence_msg_list(params) {
     ...
     * 获取群聊@全体成员剩余次数
     */
    async get_group_at_all_remain(params) {
     ...
     * 设置群头像
     */
    async set_group_portrait(params) {
     ...
     * 删除精华信息
     */
    async delete_essence_msg(params) {
     ...
     * 设置群公告
     */
    async _send_group_notice(params) {
     ...
     * 获取群公告
     */
    async _get_group_notice(params) {
     ...
     * 上传群文件
     */
    async upload_group_file(params) {
     ...
     * 删除群文件
     */
    async delete_group_file(params) {
     ...
     * 创建群文件夹
     */
    async create_group_file_folder(params) {
     ...
     * 删除群文件夹
     */
    async delete_group_folder(params) {
     ...
     * 获取群文件信息
     */
    async get_group_file_system_info(params) {
     ...
     * 获取群文件根目录列表
     */
    async get_group_root_files(params) {
     ...
     * 获取群文件夹指定文件夹列表
     */
    async get_group_files_by_folder(params) {
     ...
     * 获取群文件下载链接
     */
    async get_group_file_url(params) {
     ...
     * 上传私聊文件
     */
    async upload_private_file(params) {
     ...
     * 快速操作
     */
    '.handle_quick_operation' = async (params) => {
     ...
     * 设置在线状态
     */
    async set_online_status(params) {
     ...
     * 转发私聊信息
     */
    async forward_friend_single_msg(params) {
     ...
     * 转发群聊信息
     */
    async forward_group_single_msg(params) {
     ...
     * 标记私聊消息已读
     */
    async mark_private_msg_as_read(params) {
     ...
     * 标记群聊消息已读
     */
    async mark_group_msg_as_read(params) {
     ...
     * 创建收藏
     */
    async create_collection(params) {
     ...
     * 获取收藏列表
     */
    async get_collection_list(params) {
     ...
     * 设置签名
     */
    async set_self_longnick(params) {
     ...
     * 获取最近聊天信息
     */
    async get_recent_contact(params) {
     ...
     * 获取自定义表情
     */
    async fetch_custom_face(params) {
     ...
     * 获取群聊额外信息
     */
    async get_group_info_ex(params) {
     ...
     * 获取群忽略添加列表
     */
    async get_group_ignore_add_request(params) {
     ...
     * 删除群公告
     */
    async _del_group_notice(params) {
     ...
     * 获取用户资料信息 (?)
     */
    async fetch_user_profile_like(params) {
     ...
     * 获取陌生人信息
     */
    async nc_get_user_status(params) {
     ...
     * 获取群聊禁言列表
     */
    async get_group_shut_list(params) {
     ...
     * 获取忽略的加群通知
     */
    async get_group_ignored_notifies(params) {
     ...
     * 获取ai语音h模型列表
     */
    async get_ai_characters(params) {
     ...
     * 发送群聊ai语音
     */
    async send_group_ai_record(params) {
